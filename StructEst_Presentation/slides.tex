...
\begin{frame}[label={sec:orga6656ca}]{Lotteries}
...
\begin{frame}[label={sec:orgbfd11db}]{High  Content Lotteries}
\begin{minipage}{\linewidth}
  \centering
  \resizebox{\columnwidth}{!}{%
  \begin{tabular}{@{}lcccccccc@{}}\toprule
...
\end{frame}
\section{Model}
\label{sec:org151b8f1}

\begin{frame}[label={sec:orgc4d0b06}]{Discrete Choice - Berry (1994)}
